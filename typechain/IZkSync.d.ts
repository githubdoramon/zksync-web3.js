  ...
  encodeFunctionData(
    ...
    values: [
      ...
      },
      {
        ...
        ergsPerPubdataByteInBlock: BigNumberish;
        ergsPerCodeDecommittmentWord: BigNumberish;
        numberOfLayer1Txs: BigNumberish;
        l2LogsTreeRoot: BytesLike;
        priorityOperationsHash: BytesLike;
...
export class IZkSync extends Contract {
  ...
  functions: {
    ...
    getLastProcessedPriorityTx(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
  ...
  filters: {
    ...
    NewGovernor(newGovernor: string | null): EventFilter;
